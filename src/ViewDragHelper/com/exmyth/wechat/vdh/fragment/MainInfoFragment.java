...
import com.exmyth.wechat.vdh.activity.MainActivity;
import com.exmyth.wechat.vdh.adapter.FixedPagerAdapter;
...
public class MainInfoFragment  extends Fragment implements ViewPager.OnPageChangeListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(mView==null){
            mView=inflater.inflate(R.layout.vdh_main_info_layout,container,false);
