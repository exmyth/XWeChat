package com.exmyth.wechat.vdh.widget;

import com.exmyth.wechat.vdh.widget.ViewDragHelper.Callback;
...
public class ViewGragOne extends LinearLayout{
	...
	public ViewGragOne(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //滑动的边缘设置,可以重写onEdgeTouched()方法来拦截触摸到边缘的动作
    ...
    class  DragHelperCallback extends Callback {
        ...
        /**
         * 水平滑动 控制left
         * 一般返回第二个参数即可，不过需要对边界值做一下判断这样子View不要拖出屏幕。
         * @param child
         * @param left
         * @param dx
         * @return
