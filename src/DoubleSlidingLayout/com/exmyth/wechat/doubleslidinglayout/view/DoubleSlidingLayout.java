package com.exmyth.wechat.doubleslidinglayout.view;
...
public class DoubleSlidingLayout extends RelativeLayout implements OnTouchListener {  
     ...
     * @param attrs 
     */  
    public DoubleSlidingLayout(Context context, AttributeSet attrs) {  
        super(context, attrs);  
